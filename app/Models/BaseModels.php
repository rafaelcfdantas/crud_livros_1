...
use Illuminate\Database\Eloquent\{Collection, Model, Model as EloquentModel, Builder as EloquentBuilder};
use Illuminate\Database\Query\Builder as QueryBuilder;

/**
 * Class BaseModel
 *
 * Essa classe foi criada para resolver o problema de ClassMapping do PHPStorm com o Model Builder do Laravel.
 * Não possui nenhuma outra utilidade.
 *
 * @package App
